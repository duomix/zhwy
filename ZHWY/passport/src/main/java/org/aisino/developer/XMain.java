...
import org.aisino.developer.util.XAP;
import org.aisino.developer.util.XFile;
...
public class XMain {
	...
	public static void main(String[] args) {
		String t = "org.aisino.passport.sys";
		String tablename = "aos_api_res";
		String databasename = "zhwy";
		Map m = new HashMap();
		m.put("path", "D:\\GIT\\zhwy\\ZHWY\\passport\\");
